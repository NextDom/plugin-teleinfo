...
global_mode = ''
global_logfile = os.path.dirname(os.path.realpath(__file__)) + '/../../../log/teleinfo_deamon'
global_sleep = 0
# ----------------------------------------------------------------------------
# LOGGING
# ----------------------------------------------------------------------------
...
class Teleinfo:
    ...
    def __init__(self, device, externalip, cleapi, realpath, vitesse, mode):
...
if __name__ == "__main__":
    ...
    parser.add_option("-t", "--type", dest="type", help="type du deamon", default="single")
    ...
    if options.logpath:
        try:
            global_logfile = os.path.realpath(options.logpath) + '/teleinfo_deamon'
    ...
    if global_can_start == 'true':
        ...
        print "pidfile : " + "/tmp/teleinfo_" + options.type + ".pid"
        teleinfo = Teleinfo(global_device_name, global_external_ip, global_api, global_real_path, global_vitesse, global_mode)
