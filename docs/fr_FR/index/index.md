...
- Une fois la copie terminée, affichage d'un popup vert à droite de l'écran, vous paramétrez les index comme vous le souhaitez: libellé "HP" + champs "HCHP" sur index01 et "HC" + "HCHC" sur index02 par exemple et les tarifs qui correspondent
